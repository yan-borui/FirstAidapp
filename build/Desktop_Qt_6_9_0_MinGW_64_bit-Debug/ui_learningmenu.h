...
public:
    ...
    void setupUi(QMainWindow *LearingMenu)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/assets/icons/sorrow.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action0->setIcon(icon);
        action1 = new QAction(LearingMenu);
        action1->setObjectName("action1");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/assets/icons/bleeding.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action1->setIcon(icon1);
        action2 = new QAction(LearingMenu);
        action2->setObjectName("action2");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/assets/icons/electricshock.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action2->setIcon(icon2);
        action3 = new QAction(LearingMenu);
        action3->setObjectName("action3");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/assets/icons/hypothermia.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action3->setIcon(icon3);
        action4 = new QAction(LearingMenu);
        action4->setObjectName("action4");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/assets/icons/epilepticseizure.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action4->setIcon(icon4);
        action5 = new QAction(LearingMenu);
        action5->setObjectName("action5");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/assets/icons/dogbite.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action5->setIcon(icon5);
        action6 = new QAction(LearingMenu);
        action6->setObjectName("action6");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/assets/icons/fracture.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action6->setIcon(icon6);
        action7 = new QAction(LearingMenu);
        action7->setObjectName("action7");
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/assets/icons/anaphylaxis.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action7->setIcon(icon7);
        action8 = new QAction(LearingMenu);
        action8->setObjectName("action8");
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/assets/icons/alcoholism.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action8->setIcon(icon8);
        action9 = new QAction(LearingMenu);
        action9->setObjectName("action9");
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icons/assets/icons/strains&sprains.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action9->setIcon(icon9);
        action10 = new QAction(LearingMenu);
        action10->setObjectName("action10");
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icons/assets/icons/craniocerebraltrauma.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action10->setIcon(icon10);
        action11 = new QAction(LearingMenu);
        action11->setObjectName("action11");
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icons/assets/icons/heatstroke.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action11->setIcon(icon11);
        action12 = new QAction(LearingMenu);
        action12->setObjectName("action12");
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/icons/assets/icons/drowning.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action12->setIcon(icon12);
        action13 = new QAction(LearingMenu);
        action13->setObjectName("action13");
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/icons/assets/icons/airwayobstruction.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action13->setIcon(icon13);
        action14 = new QAction(LearingMenu);
        action14->setObjectName("action14");
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/icons/assets/icons/burn&scald.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action14->setIcon(icon14);
        action15 = new QAction(LearingMenu);
        action15->setObjectName("action15");
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/icons/assets/icons/diabetic.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action15->setIcon(icon15);
        action16 = new QAction(LearingMenu);
        action16->setObjectName("action16");
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/icons/assets/icons/bandaging.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action16->setIcon(icon16);
        action17 = new QAction(LearingMenu);
        action17->setObjectName("action17");
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/icons/assets/icons/unconsciousspontaneousbreathing.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action17->setIcon(icon17);
        action18 = new QAction(LearingMenu);
        action18->setObjectName("action18");
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/icons/assets/icons/unconsciouswithoutspontaneousbreathing.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action18->setIcon(icon18);
        action19 = new QAction(LearingMenu);
        action19->setObjectName("action19");
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/icons/assets/icons/fever&convulsions.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action19->setIcon(icon19);
        action20 = new QAction(LearingMenu);
        action20->setObjectName("action20");
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/icons/assets/icons/asthmatic.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action20->setIcon(icon20);
        action21 = new QAction(LearingMenu);
        action21->setObjectName("action21");
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/icons/assets/icons/heartattack.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action21->setIcon(icon21);
        action22 = new QAction(LearingMenu);
        action22->setObjectName("action22");
        QIcon icon22;
        icon22.addFile(QString::fromUtf8(":/icons/assets/icons/shock.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action22->setIcon(icon22);
        action23 = new QAction(LearingMenu);
        action23->setObjectName("action23");
        QIcon icon23;
        icon23.addFile(QString::fromUtf8(":/icons/assets/icons/bites.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action23->setIcon(icon23);
        action24 = new QAction(LearingMenu);
        action24->setObjectName("action24");
        QIcon icon24;
        icon24.addFile(QString::fromUtf8(":/icons/assets/icons/poisoning.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action24->setIcon(icon24);
        action25 = new QAction(LearingMenu);
        action25->setObjectName("action25");
        QIcon icon25;
        icon25.addFile(QString::fromUtf8(":/icons/assets/icons/meningitis.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action25->setIcon(icon25);
        action26 = new QAction(LearingMenu);
        action26->setObjectName("action26");
        QIcon icon26;
        icon26.addFile(QString::fromUtf8(":/icons/assets/icons/stroke.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action26->setIcon(icon26);
        action_B = new QAction(LearingMenu);
        action_B->setObjectName("action_B");
        action_B->setIcon(icon1);
        action_H = new QAction(LearingMenu);
        action_H->setObjectName("action_H");
        action_H->setIcon(icon21);
        action_S = new QAction(LearingMenu);
        action_S->setObjectName("action_S");
        action_S->setIcon(icon14);
        action_Y = new QAction(LearingMenu);
        action_Y->setObjectName("action_Y");
        action_Y->setIcon(icon13);
        action_U = new QAction(LearingMenu);
        action_U->setObjectName("action_U");
        action_U->setIcon(icon18);
        action_P = new QAction(LearingMenu);
        action_P->setObjectName("action_P");
        QIcon icon27;
        icon27.addFile(QString::fromUtf8(":/icons/assets/icons/Prevent.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        action_P->setIcon(icon27);
        ...
        Steps->setGeometry(QRect(80, 60, 891, 381));
        QFont font2;
        ...
        menubar->setGeometry(QRect(0, 0, 1008, 18));
        ...
        menu_L->addAction(action_B);
        menu_L->addAction(action_H);
        menu_L->addAction(action_S);
        menu_L->addAction(action_Y);
        menu_L->addAction(action_U);
        menu_L->addAction(action_P);
    ...
    void retranslateUi(QMainWindow *LearingMenu)
    {
        ...
        action_B->setText(QCoreApplication::translate("LearingMenu", "\345\207\272\350\241\200\357\274\210&B\357\274\211", nullptr));
        action_H->setText(QCoreApplication::translate("LearingMenu", "\345\277\203\350\204\217\347\227\205\345\217\221\344\275\234\357\274\210&H)", nullptr));
        action_S->setText(QCoreApplication::translate("LearingMenu", "\347\203\247\347\203\253\344\274\244\357\274\210&S\357\274\211", nullptr));
        action_Y->setText(QCoreApplication::translate("LearingMenu", "\346\260\224\351\201\223\346\242\227\351\230\273\357\274\210&A\357\274\211", nullptr));
        action_U->setText(QCoreApplication::translate("LearingMenu", "\346\227\240\346\204\217\350\257\206\346\234\211\350\207\252\344\270\273\345\221\274\345\220\270\357\274\210&U\357\274\211", nullptr));
        action_P->setText(QCoreApplication::translate("LearingMenu", "\351\242\204\351\230\262\357\274\210&P\357\274\211", nullptr));
        ...
        menu_L->setTitle(QCoreApplication::translate("LearingMenu", "\346\265\213\350\257\225\357\274\210&T\357\274\211", nullptr));
    } // retranslateUi
